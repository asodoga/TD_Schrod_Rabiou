...
plot [0.4:][:] '/Users/issa/Developpements/TD_Schrod_Rabiou/results_H_nb5/file_norm_pics_hagedorn_taylor.txt' u 1:2 w l lw 2    t " nb=5",\
...
plot[0.4:][:] '/Users/issa/Developpements/TD_Schrod_Rabiou/results_H_nb5/file_norm_pics_hagedorn_taylor.txt' u 1:3 w l lw 2 t " nb=5 ",\
...
plot [0.4:][:] '/Users/issa/Developpements/TD_Schrod_Rabiou/results_H_nb5/Norm_13_hagedorn_taylor.txt' u 1:2 w l lw 2 t " nb=5",\
...
plot [0.4:][:] '/Users/issa/Developpements/TD_Schrod_Rabiou/results_H_nb5dt$i/file_norm_pics_hagedorn_taylor.txt' u 1:2 w l lw 2 t " nb=5 dt=$i ",\
'/Users/issa/Developpements/TD_Schrod_Rabiou/results_H_nb5dt$i/file_norm_pics_hagedorn_taylor.txt' u 1:3 w l lw 2 t " nb=5 dt=$i "
...
plot[0.4:][:] '/Users/issa/Developpements/TD_Schrod_Rabiou/results_H_nb5dt0.4/file_norm_pics_hagedorn_taylor.txt' u 1:2 w l lw 2 t " nb=5 dt=0.4 ",\
...
#set key right bottom
#
#plot[0.4:][:] '/Users/issa/Developpements/TD_Schrod_Rabiou/results_H_nb5dt0.4/file_norm_pics_hagedorn_taylor.txt' u 1:3 w l lw 2 t " nb=5 dt=0.4 ",\
...
plot [0.4:][:] '/Users/issa/Developpements/TD_Schrod_Rabiou/results_H_nb5dt0.4/Norm_13_hagedorn_taylor.txt' u 1:2 w l lw 2 t " nb=5 dt= 0.4 ",\
...
set ylabel "At (ua)" font "Times-news-romain,12"
...
set ylabel "Bt (ua)" font "Times-news-romain,12"
set xlabel "Time (ua)" font "Times-news-romain,12"
#set xtics 6
...
set boxwidth  3
set style fill solid 0.5 noborder
plot [-1:][-0.6:0.6] '/Users/issa/Developpements/TD_Schrod_Rabiou/results_H_nb10/alpha_hagedorn_taylor.txt' u 1:4 w l lw 2 t " nb=10 dt=0.25 {Bt_{1}}" ,\
'/Users/issa/Developpements/TD_Schrod_Rabiou/results_H_nb10/alpha_hagedorn_taylor.txt' u 1:5 w  l lw 2 t " nb=10 dt=0.25  {Bt_{2}} "
...
set ylabel "Qt (ua)" font "Times-news-romain,12"
set xlabel "Time (ua)" font "Times-news-romain,12"
#set xtics 6
...
set boxwidth  3
set style fill solid 0.5 noborder
plot [-0.5:][-2.5:3] '/Users/issa/Developpements/TD_Schrod_Rabiou/results_H_nb10/Qt_hagedorn_taylor.txt' u 1:2 w l lw 2 t " nb=10 dt=0.25 {qt_{1}}" ,\
'/Users/issa/Developpements/TD_Schrod_Rabiou/results_H_nb10/Qt_hagedorn_taylor.txt' u 1:3 w l lw 2 t " nb=10 dt=0.25  {qt_{2}} "
...
set ylabel "Pt (ua)" font "Times-news-romain,12"
set xlabel "Time (ua)" font "Times-news-romain,12"
set xtics 6
...
set boxwidth  3
set style fill solid 0.5 noborder
plot [-0.5:][-2.5:3] '/Users/issa/Developpements/TD_Schrod_Rabiou/results_H_nb10/imp_k_hagedorn_taylor.txt' u 1:2 w l lw 2 t " nb=10 dt=0.25 {pt_{1}} " ,\
'/Users/issa/Developpements/TD_Schrod_Rabiou/results_H_nb10/imp_k_hagedorn_taylor.txt' u 1:3 w l lw 2 t " nb=10 dt=0.25  {pt_{2}}"
