...
Op_m.f90 param_WP0_m.f90 Auto_corr_m.f90 Propa_m.f90 Sub_Vp_m.f90
...
$(OBJ_DIR)/Op_m.o: $(OBJ_DIR)/Molec_m.o $(OBJ_DIR)/psi_m.o $(OBJ_DIR)/Basis_m.o 

$(OBJ_DIR)/lanczos_m.o: $(OBJ_DIR)/Op_m.o $(OBJ_DIR)/psi_m.o  

$(OBJ_DIR)/Propa_m.o: $(OBJ_DIR)/Auto_corr_m.o $(OBJ_DIR)/lanczos_m.o $(OBJ_DIR)/Op_m.o $(OBJ_DIR)/Ana_psi_m.o $(OBJ_DIR)/Sub_Vp_m.o\
