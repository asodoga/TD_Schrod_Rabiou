...
LIBSRC= NumParameters_m.f90 UtilLib_m.f90 diago_m.f90 \
 Molec_m.f90 NDindex_m.f90 Basis_m.f90 psi_m.f90 Ana_psi_m.f90 lanczos_m.f90 Op_m.f90 param_WP0_m.f90 Auto_corr_m.f90 Propa_m.f90
OBJ0=${LIBSRC:.f90=.o}
...
$(OBJ_DIR)/Auto_corr_m.o: $(OBJ_DIR)/psi_m.o
