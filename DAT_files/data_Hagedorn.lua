...
&basis_nd name='HO' nb =150 nq=180 Q0 =2.0 SCALEQ = 1.0 Imp_k=0.0  alpha =( 1.,0.0) /
&basis_nd name='HO' nb =150 nq=180 Q0 =0.0 SCALEQ = 1.0 Imp_k=0.0  alpha =( 1.,0.0) /
...
max_iter =  15  propa_name ='hagedorn'  propa_name2 = 'sil' Beta = T  P = T /
