...
&basis_nd name='dp' nb_basis=3 /
  &basis_nd name='HO' nb =$nb nq=$nq Q0 =2.0 SCALEQ = 1.0 Imp_k=0.0  alpha =( 1.2,0.0) /
...
&defGWP ndim=2  Elecindex = 1 Coef=(1.,0.)/
  &defWP0  sigma=  1.2909944487  Beta=0.0  Qeq= 2.0   imp_k=0.0 gamma=0.0 /
  &defWP0  sigma=  1.41421356237309504880168872421  Beta=0.0  Qeq= 0.0   imp_k=0.0 gamma=0.0 /

&prop t0=0.0  tf=60. delta_t=$3 eps=1.e-20
